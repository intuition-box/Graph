...
const SmartSearchInterface = ({ endpoint, onSearch, isSearching, onSearchStart }) => {
  ...
  const {
    isSearching: graphIsSearching,
    setIsSearching: setGraphIsSearching
  ...
  const handleSearch = async () => {
    ...
    try {
      console.log("Searching with filters:", { query, selectedFilters, endpoint });
